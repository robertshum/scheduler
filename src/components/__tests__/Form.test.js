...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    //final fn that gets called if it passes validation
    ...
    //looks for a "Save" value inside dom, and 'clicks' it.
    fireEvent.click(getByText("Save"));

    expect(getByText(/student name cannot be blank/i)).toBeInTheDocument();

    //never called because validation should stop it.
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(
      <Form interviewers={interviewers} onSave={onSave} name="Joe Blow"/>
    );
